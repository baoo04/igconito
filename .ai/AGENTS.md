...
services/
  ...
  delivery-payment-service/  → Delivery & payment microservice
  gateway-service/           → Spring Cloud Gateway (routes /menu, /orders, /delivery)
docs/
...
3. Use Docker Compose service names for inter-service calls (e.g., `http://menu-service:5000`)
