...
curl http://localhost:5001   # Menu Service
curl http://localhost:5002   # Order Service
curl http://localhost:5003   # Delivery & Payment Service
...
│   │   ├── readme.md
│   │   └── src/
│   └── gateway-service/            # Spring Cloud Gateway (used by Compose)
│       ├── Dockerfile
│       ├── readme.md
│       └── src/
│
...
```
main
 └── feature/menu-service-endpoints    ← each member works on a feature branch
